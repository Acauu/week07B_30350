package com.example.week07b_30350;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void isiDaftarVideo(){
        ...
        daftarVideo.add(new SumberVideo("Kejar- kejaran","Kejar-kejara di jalanan hasil cuplikan dari film The Fast and The Furious","android.resource://"+getPackageName()+"/"+R.raw.drift02));
